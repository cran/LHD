...
Another optimality criterion to be introduced is the maximum projection criterion (Joseph, Gul and Ba (2015)), which focuses on the peojection property of the design matrix, and its formula is given by the following

...
#'
#' \code{OLHD1998} returns an orthogonal Latin hypercube design generated by the construction method of Ye (1998)
#'
...
OLHD1998=function(m){
  ...
  if(m>=3){
    ...
    for (i in 1:(m-1-1)) {    #L=1,...,m-1. However, When L=m-1, m-1-L=0, and AL cannot be calcultated
      #within the loop. So L=1,...,m-2, and AL with L=m-1 will be calculated separately
      a=1
  ...
  ak=array(0,dim=c(q,1,m-1))  #there are m-1 of AL's

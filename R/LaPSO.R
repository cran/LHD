...
#'
#' \code{LaPSO} returns a \code{n} by \code{k} LHD matrix generated by particle swarm optimization algorithm (PSO)
#'
...
#' @param m A positive integer, which stands for the number of particles. The default is set to be 10. A large value of \code{m} will result a high CPU time, and it is recommended to be no greater than 100.
...
#' @param SameNumP A non-negative integer, which stands for how many elements in current column of current particle LHD should be the same as corresponding Personal Best. SameNumP=0, 1, 2, ..., n, and 0 means to skip the "exchange".  The default is set to be 0.
#' @param SameNumG A non-negative integer, which stands for how many elements in current column of current particle LHD should be the same as corresponding Global Best. SameNumP=0, 1, 2, ..., n, and 0 means to skip the "exchange".  The default is set to be \code{n}/4. \code{SameNumP} and \code{SameNumG} cannot be 0 at the same time.
#' @param p0 A probability of exchanging two randomly selected elements in current column of current particle LHD. The default is set to be 1/(\code{k} - 1).
...
#'
#' @return If all inputs are logical, then the output will be a \code{n} by \code{k} LHD. Here are some general suggestions about the parameters: \itemize{
...
LaPSO=function(n,k,m=10,N=10,SameNumP=0,SameNumG=n/4,p0=1/(k-1),OC="phi_p",p=15,q=1,maxtime=5){

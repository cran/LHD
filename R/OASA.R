...
#'
#' @return If all inputs are logical, then the output will be an LHD whose sizes are the same as input OA.
#' @details \itemize{
...
OASA=function(OA,N=10,T0=10,rate=0.1,Tmin=1,Imax=5,OC="phi_p",p=15,q=1){
  n=dim(OA)[1]
  m=dim(OA)[2]

...
#'
#' \code{OLHD2010} returns an orthogonal Latin hypercube design generated by the construction method of Sun et al. (2010)
#'
#' @param C A positive integer.
#' @param r A positive integer.
#' @param type Design run size type, and it could be either odd or even. If \code{type} is odd (the default setting), \code{OLHD2010} returns an OLHD with run size \code{r2^{C+1}+1}. If \code{type} is even, \code{OLHD2010} returns an OLHD with run size \code{r2^{C+1}}.
#'
...
#' OLHD2010(C=3,r=3,type="odd")
#'
#' #create an orthogonal LHD with C=3, r=3, type="even".
#' #So n=3*2^4=48 and k=2^3=8
#' OLHD2010(C=3,r=3,type="even")
#'
#' @export

OLHD2010=function(C,r,type="odd"){
